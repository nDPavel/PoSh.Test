...
# 
# Purpose: To provide a graphical user interface to send messages
#          over the network using msg.exe in place of the oft-lamented net send.
#
# Help: Run the script and press F1 to open the help menu
#
# Acknowledgements and Contributions: Run the script and go to "About Message Center"
######################################################################################
